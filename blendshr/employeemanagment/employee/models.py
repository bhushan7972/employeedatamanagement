...
#     EmployeeGradeID = models.UUIDField(unique=True)
#     EmployeeGrade = models.CharField(max_length=50)
#     CreatedDate = models.DateTimeField(auto_now_add=True)
#     CreatedBy = models.UUIDField(unique=True)
#     ModifiedBy = models.UUIDField(unique=True)
...
#     LeaveCategoryID = models.UUIDField(unique=True)
...
class  EmployeeLeaveCategory(models.Model):
    EmployeeLeaveCategoryMapID = models.UUIDField(unique = True, editable = False)
    EmployeeId = models.UUIDField(unique = True,editable = False)
    LeaveCategoryId = models.UUIDField(unique = True, editable = False)
    StartDate =models.DateTimeField(null=True)
    EndDate = models.DateTimeField(null=True)
    TotalDay = models.DecimalField(max_length=1000)
    IsFirstHalfDay_choice = [('Yes', 'Yes'), ('No', 'No')
                   ]
    Is_First_Half_Day  = models.CharField(max_length=20,choices=IsFirstHalfDay_choice,null=True)
    IsLastHalfDay_choice = [('Yes', 'Yes'), ('No', 'No')
                             ]
    Is_Last_Half_Day  = models.CharField(max_length=20,choices=IsLastHalfDay_choice,null=True)
    ...
    CreatedDate = models.DateTimeField(auto_now_add=True)
    CreatedBy =  models.UUIDField(unique = True, editable = False)
    ModifiedBy =  models.UUIDField(unique = True, editable = False)
    ModifiedDate = models.DateTimeField(auto_now_add=True)
    IsActive = models.BooleanField(default=False)
    ...
    @property
    def TotalDay(self):
        return (self.StartDate - self.EndDate).days + 1
